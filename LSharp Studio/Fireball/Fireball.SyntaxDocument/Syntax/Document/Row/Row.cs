...
//	//	public	  char[]					Buffer_Separators	=null;
		...
		private IBookmark mBookmark = null; //is this line bookmarked?
		private IBreakpoint mBreakpoint = null; //Does this line have a breakpoint?
        private bool mLineMarked = false;
        private bool mWillLineMarked = false;
		/// <summary>
		/// For public use only
		/// </summary>
        ...
        {
            get { return mLineMarked; }
            set { mLineMarked = value; }
        }

        public bool WillLineMarked
        {
            get { return mWillLineMarked; }
            set { mWillLineMarked = value; }
        }
