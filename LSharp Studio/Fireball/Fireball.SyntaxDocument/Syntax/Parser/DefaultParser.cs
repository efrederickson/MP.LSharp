        ...
        private void ParseText(Row Row, Segment CurrentSegment, string Text)
        {
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    ParseTools.AddPatternString(Word.Token, Row, Word.Pattern, Word.ParentList.Style, Word.ParentList.MatchingStyle, CurrentSegment, false);
        ...
        private void InternalParseLine(int index, bool ParseKeywords)
        {
            ...
            while (true)
            {
                ...
                if ((EndSegment.HasContent && ChildSegment.HasContent && EndSegment.Position <= ChildSegment.Position) || (EndSegment.HasContent && ChildSegment.HasContent == false))
                {
                    ...
                    ParseTools.AddPatternString(EndSegment.Token, Row, EndSegment.Pattern, st2, null, CurrentSegment, false);
                ...
                else if (ChildSegment.HasContent)
                {
                    ...
                    ParseTools.AddPatternString(ChildSegment.Token, Row, ChildSegment.Pattern, st2, null, NewSeg, false);
                    NewSeg.StartRow = Row;
