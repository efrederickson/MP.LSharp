...
//				}
		...
		private void btnReplaceAll_Click(object sender, EventArgs e)
		{
			...
			while (mOwner.SelectNext(cboFind.Text, chkMatchCase.Checked, chkWholeWord.Checked, chkRegEx.Checked, false))
			{
				this.mOwner.ReplaceSelection(cboReplace.Text);
			}
		...
		private void btnMarkAll_Click(object sender, EventArgs e)
		{
			...
			while (mOwner.SelectNext(cboFind.Text, chkMatchCase.Checked, chkWholeWord.Checked, chkRegEx.Checked, false))
			{
				this.mOwner.Caret.CurrentRow.Bookmark.Enabled = true;
			}
		...
		public void FindNext()
		{
			...
			mOwner.SelectNext(cboFind.Text, chkMatchCase.Checked, chkWholeWord.Checked, chkRegEx.Checked, false);
		}
	}
}
