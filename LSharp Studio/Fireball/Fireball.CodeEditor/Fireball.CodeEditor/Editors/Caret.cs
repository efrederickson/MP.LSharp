...
namespace Fireball.Windows.Forms.CodeEditor
{
	...
	public sealed class Caret
	{
        ...
        /// <summary>
        /// Gets the word to the left of the caret.
        /// This only applies if the active row is fully parsed.
        /// </summary>
        /// <returns>a Word object from the active row</returns>
        public Word CurrentLeftWord
        {
            get { return this.Control.Document.GetWordFromPos(this.Position, true); }
        }
        ...
        /// </summary>
        /// <returns>a Word object from the active row</returns>
        public Word CurrentRightWord
        {
            get { return this.Control.Document.GetWordFromPos(this.Position, false); }
        }
