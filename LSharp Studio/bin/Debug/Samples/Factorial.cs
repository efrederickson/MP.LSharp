...
namespace LSharp
{
	...
	/// </summary>
	public class ClassName1047753041
	{
		string[] LSharpCode = {";; Factorial","","; the Factorial function","(defun fact(n) ","	(if (eql n 0) 1 (* n (fact (- n 1)))))","",";; call it","(fact 5)"};
		...
		public static void Main(string[] args)
		{
			...
			new ClassName1047753041().Activate(args);
		}
