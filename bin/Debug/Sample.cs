...
namespace LSharp
{
    ...
    /// </summary>
    public class ClassName468126390
    {
        string[] LSharpCode = {"(= frm (new System.Windows.Forms.Form ))",
"(set_Size frm (new System.Drawing.Size 100 100))",
"(set_Name frm \"Form1\")",
"(set_TabIndex frm 1)",
"(showdialog frm)",
"(prl \"WTF Tester from L#!\")"};
        ...
        public static void Main(string[] args)
        {
            ...
            new ClassName468126390().Activate(args);
        }
